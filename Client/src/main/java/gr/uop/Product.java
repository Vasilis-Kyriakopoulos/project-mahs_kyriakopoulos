...
//Κλάση που αναπαριστά μια υπερησία που προσφέρει η εφαρμογή δηλαδή κρατά το id της υπηρεσίας 
//το όνομα της υπηρεσίας (πχ κέρωμα) και τις τίμες ανάλογα τον τύπο οχήματος.
